...
VALUES
('严厉压力面', '节奏紧凑，持续追问方案边界、失败场景和取舍依据。', '保持专业但直接，优先追问候选人回答中的模糊点、风险点和落地证据。', '用于检验抗压能力和问题拆解深度', 'stern-panel', '冷静追问官', '节奏紧凑，关注风险、证据和边界条件。', TRUE, 10),
('温和引导面', '通过提示和澄清帮助候选人逐步展开思路。', '语气温和，先肯定有效信息，再用开放问题引导候选人补充上下文、过程和结果。', '用于基础能力评估和新人面试', 'warm-guide', '引导型导师', '语气温和，帮助候选人逐步展开经历和思路。', TRUE, 20),
('技术深挖面', '围绕核心技术细节、架构选择和性能可靠性连续深入。', '聚焦技术原理、工程实践和权衡，请持续要求候选人解释为什么这样设计。', '用于技术岗位复试', 'tech-architect', '架构深挖官', '聚焦技术原理、系统设计和工程取舍。', TRUE, 30),
('HR 综合面', '关注沟通表达、团队协作、动机匹配和职业规划。', '从经历、协作、复盘和稳定性角度提问，避免深入到过窄技术细节。', '用于综合素质评估', 'hr-partner', '综合评估官', '关注表达、协作、复盘和长期匹配度。', TRUE, 40),
('挑战面试官', '设置复杂场景和突发问题，检验候选人的应变能力。', '模拟真实工作中的突发场景，频繁追加约束条件，观察候选人的问题分解和决策逻辑。', '用于高级岗位和核心岗位面试', 'challenge-master', '挑战面试官', '通过复杂场景和突发问题检验应变能力。', TRUE, 50),
('实战演练官', '结合实际项目案例，模拟真实工作场景进行演练。', '以真实项目为背景，要求候选人现场分析和解决问题，评估实战经验和动手能力。', '用于中高级技术岗位实战评估', 'practice-coach', '实战演练官', '结合实际项目案例评估实战能力。', TRUE, 60);
...
('challenge-master', '挑战面试官', '通过复杂场景和突发问题检验应变能力。', NULL, '#dc2626', '挑战', TRUE, 50),
('practice-coach', '实战演练官', '结合实际项目案例评估实战能力。', NULL, '#059669', '实战', TRUE, 60);
