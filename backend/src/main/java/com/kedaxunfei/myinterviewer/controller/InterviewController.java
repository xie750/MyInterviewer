...
public class InterviewController {
    ...
    @GetMapping
    public ApiResponse<List<InterviewSummaryResponse>> listOwnInterviews(
            @AuthenticationPrincipal AuthenticatedUser user
    ) {
        return ApiResponse.success(interviewService.listOwnInterviews(user));
    }
    ...
    public ApiResponse<InterviewReportResponse> getReport(
        ...
        return ApiResponse.success(interviewService.getOwnReport(user, id));
    }
}
